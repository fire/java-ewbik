...
public class UI {
    ...
    public void drawBoneInfo(PGraphics pg, Bone bone, int idx) {
        ...
        try {
            ...
            boneAngles += " D ( " + PApplet.degrees((float) angleArr[0]) + ",   " + PApplet.degrees((float) angleArr[1])
                    + ",   " + PApplet.degrees((float) angleArr[2]) + "  )";
            pg.fill(0);
    ...
    public void drawPins(PGraphics pg, IKPin activePin,
        ...
        if (activePin != null) {
            ...
            pg.stroke(255, 0, 255);
            float totalpriorities = (float) (activePin.getXPriority() + activePin.getYPriority()
     ...
     * This is used as kind of a hack so I don't have to bother writing
