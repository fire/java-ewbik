...
public class Transform3D {
    ...
    public <T extends Transform3D> Transform3D(T input) {
     ...
     * @param in
     */
    public <T extends Transform3D> void adoptValues(T in) {
    ...
    public <B extends Transform3D> void setToLocalOf(B global_input, B local_output) {
     ...
     * @param globalOutput
     */
    public <T extends Transform3D> void setToGlobalOf(T localInput, T globalOutput) {
